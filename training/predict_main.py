...
PYTHON_PATH='/media/pilab/ssd_data/test/miniconda2/envs/theano/bin/python2.7';
...
cmd2=PYTHON_PATH+' '+ GLOBAL_PATH + '/lib/DLS2F_evaluate_SCOP.py  '+ test_datafile  + '  '+GLOBAL_PATH +'/datasets/D1_SimilarityReduction_dataset/fold_label_relation2.txt  '  + resultdir + '  ' + results_test
print "Running ", cmd2,"\n\n"
os.system(cmd2)
